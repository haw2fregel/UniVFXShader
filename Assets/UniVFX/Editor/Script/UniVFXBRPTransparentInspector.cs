...
{
    public class UniVFXBRPTransparentInspector : ShaderGUI
    {
        ParticleSystem _ps;
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            if (_options == null)
            {
                ...
                _options.Add(new SurfaceOptionTransparent(false, true));
            }
        ...
        public void ConvertUniqueShader(MaterialEditor materialEditor)
        {
            ...
            shaderCode += "        }\n";
            shaderCode += "    }\n";
            shaderCode += "    CustomEditor \"UniVFX.Editor.UniVFXUniqueBRPTransparentInspector\"\n";
            shaderCode += "}\n";
