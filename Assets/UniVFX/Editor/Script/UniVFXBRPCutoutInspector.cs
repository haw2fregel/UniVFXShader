...
{
    public class UniVFXBRPCutoutInspector : ShaderGUI
    {
        ParticleSystem _ps;
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            if (_options == null)
            {
                ...
                _options.Add(new SurfaceOptionCutout(false, true));
            }
        ...
        public void ConvertUniqueShader(MaterialEditor materialEditor)
        {
            ...
            shaderCode += "    {\n";
            shaderCode += "        Tags { \"RenderType\" = \"Opaque\" \"UniversalMaterialType\" = \"Unlit\" \"Queue\" = \"AlphaTest\" }\n";
            shaderCode += "        Pass\n";
            shaderCode += "        {\n";
            shaderCode += "            Cull Off\n";
            ...
            if (useUVChannelList[5].Count >= 1)
                shaderCode += "                float3 viewNormal = mul((float3x3)UNITY_MATRIX_V, UnityObjectToWorldNormal(v.normal)) + 0.5;\n";
            if (SurfaceFade.IsActive(material) || FakeLight.IsActive(material) || UVParallax.IsActive(material))
            ...
            if (UVParallax.IsActive(material))
            {
                ...
                shaderCode += "                float3 worldSpaceViewDirection = normalize(UnityWorldSpaceViewDir(i.worldPos));\n";
            ...
            shaderCode += "        }\n";
            shaderCode += "    }\n";
            shaderCode += "    CustomEditor \"UniVFX.Editor.UniVFXUniqueBRPCutoutInspector\"\n";
            shaderCode += "}\n";
