...
{
    public class UniVFXBRPCanvasInspector : ShaderGUI
    {
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            if (_options == null)
            {
                ...
                _options.Add(new MainTexture(true, true));
                _options.Add(new MaskTexture(true, true));
                _options.Add(new BlendTexture(true, true));
                _options.Add(new GradationColor(true, true));
                _options.Add(new Dissolve(true, true));
                _options.Add(new UVDistortion(true, true));
                _options.Add(new UVBend(true, true));
                _options.Add(new UVRotate(true, true));
                _options.Add(new UVFripBook(true, true));
                _options.Add(new HSVShift(true, true));
                _options.Add(new Time(true, true));
                _options.Add(new SurfaceOptionCanvas(true, true));
            }
        ...
        public void ConvertUniqueShader(MaterialEditor materialEditor)
        {
            ...
            shaderCode += "            #include \"UnityCG.cginc\"\n";
            shaderCode += "\n";
            ...
            shaderCode += "            SamplerState SamplerState_Linear_Clamp;\n";
            shaderCode += "            SamplerState SamplerState_Linear_Repeat;\n";
            ...
            shaderCode += "                o.positionCS = UnityObjectToClipPos(v.vertex.xyz);\n";
            shaderCode += "                return o;\n";
            shaderCode += "            }\n";
            shaderCode += "\n";
            ...
            shaderCode += "        }\n";
            shaderCode += "    }\n";
            shaderCode += "    CustomEditor \"UniVFX.Editor.UniVFXUniqueBRPCanvasInspector\"\n";
            shaderCode += "}\n";
