...
{
    public class UniVFXBRPOpaqueInspector : ShaderGUI
    {
        ParticleSystem _ps;
        ...
        public void ConvertUniqueShader(MaterialEditor materialEditor)
        {
            ...
            shaderCode += "    {\n";
            shaderCode += "        Tags { \"RenderType\" = \"Opaque\" \"UniversalMaterialType\" = \"Unlit\" \"Queue\" = \"Geometry\" }\n";
            shaderCode += "        Pass\n";
            shaderCode += "        {\n";
            ...
            shaderCode += "        }\n";
            shaderCode += "    }\n";
            shaderCode += "    CustomEditor \"UniVFX.Editor.UniVFXUniqueBRPOpaqueInspector\"\n";
            shaderCode += "}\n";
